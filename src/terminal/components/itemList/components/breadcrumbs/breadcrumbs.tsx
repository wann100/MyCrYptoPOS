...
const Breadcrumbs: React.FC = () => {
  ...
  const currentCategory = categories.find((category: { id: any; }) => currentCategoryId === category.id);
  const middleCategory = currentCategory
    ? categories.find((category: { id: any; }) => currentCategory.parentId === category.id)
    : undefined;
